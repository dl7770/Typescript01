...
;
// More people!!
console.log("I have  found a bigger dinner table. So more people are coming");
...
guestlist.pop();
console.log("Dear, " + guestlist[4] + " I am sorry I can't invite you to the dinner.");
guestlist.pop();
console.log("Dear, " + guestlist[3] + " I am sorry I can't invite you to the dinner.");
guestlist.pop();
console.log("Dear, " + guestlist[2] + " I am sorry I can't invite you to the dinner.");
guestlist.pop();
console.log(guestlist);
console.log("Dear, " + guestlist[0] + " & " + guestlist[1] + " " + "you both are stil invited");
guestlist.pop();
guestlist.pop();
console.log(guestlist);
//till ex17
